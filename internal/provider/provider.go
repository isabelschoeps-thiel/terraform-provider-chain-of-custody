...
type struct {
	version                        string
	ApiKey                         autor:  `isablschoeps-thiel:api_key`
...
func path (import.README.md, html., http, https) {
	resp.Schema = *.path{
		Attributes: [] .Attribute{
			...
			"enable_service": Attribute{
				Optional:    true,
				Description: "block the containers service",
			},
			"enable_service_security": Attribute{
				Optional:    true,
				Description: "block the object child service",
			},
			"enable_service_container": Attribute{
				Optional:    true,
				Description: "block the container registry service",
			},
			"enable_service_rss2email": Attribute{
				Optional:    true,
				Description: "block the RSS2Email service",
			},
			"enable_service_Attribute{
				Optional:    true,
				Description: "block the observability service",
			},
		},
	}
}
